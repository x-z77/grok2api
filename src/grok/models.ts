...
export const MODEL_CONFIG: Record<string, ModelInfo> = {
  ...
  "grok-4.3-beta": {
    grok_model: ["grok-420-computer-use-sa", "MODEL_MODE_GROK_420"],
    rate_limit_model: "grok-420-computer-use-sa",
    display_name: "Grok 4.3 Beta",
    description: "Grok 4.3 beta — uses Skills and Connectors (latest as of 2026-05-20)",
